...
@Entity /*mapped to a database */
@Table(name="ProductMS") /* name of the databasetable used for mapping*/
public class ProductDto {
	@Id /* defining ID as primarykey */
	...
	public ProductDto(String productId, double price, String colour, String dimension, String specification,
		...
		super(); /* refer the superclass methods*/
		this.productId = productId;
		this.price = price;
		this.colour = colour;
		this.dimension = dimension; /* eliminate confusion between the class attributes and parameters with same name */
	...
	public String getProductId() {
		return productId; /*generation of getters and setters */
	}
