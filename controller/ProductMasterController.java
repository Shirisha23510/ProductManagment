...
public class ProductMasterController {
	...
	@PostMapping("/addproduct")/* @requestmapping= requestmethod.post*/
	String addProduct(@RequestBody ProductDto product) throws ProductAlreadyExistsException {
	...
	String deleteProduct(@PathVariable String productId ) throws ProductNotfoundException{ /*name of the pathvariable is required method parameter
	is to bound the URL */
